...
function RayfieldLibrary:SaveConfiguration()
	...
	writefile(ConfigurationFolder .. "/" .. CFileName, tostring(HttpService:JSONEncode(Data)))
end
...
function RayfieldLibrary:LoadConfiguration()
	if CEnabled then
		pcall(function()
			if isfile(ConfigurationFolder .. "/" .. CFileName) then
...
task.delay(6, RayfieldLibrary.LoadConfiguration, RayfieldLibrary)
